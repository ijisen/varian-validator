...
interface DefaultCurrencyOptions {
  symbol: string;
  ...
  digits_after_decimal: any[];
  allow_space_after_digits: boolean;
}

function currencyRegex(options: DefaultCurrencyOptions) {
...
const isCurrency = (str: any, options: DefaultCurrencyOptions) => {
  assertString(str);
